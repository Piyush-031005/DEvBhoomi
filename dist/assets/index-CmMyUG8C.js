...
`;H_.registerPlugin(ox);var rS=new Sx({duration:1.5,easing:e=>Math.min(1,1.001-2**(-10*e)),direction:`vertical`,gestureDirection:`vertical`,smooth:!0});rS.on(`scroll`,ox.update),H_.ticker.add(e=>{rS.raf(e*1e3)}),H_.ticker.lagSmoothing(0);var iS=document.getElementById(`canvas-container`),aS=new Nn;aS.fog=new jn(`#0a0a0a`,.008);var oS=new js(60,window.innerWidth/window.innerHeight,.1,1e3);oS.position.set(0,0,20);var sS=new Ad({antialias:!0,alpha:!0});sS.setSize(window.innerWidth,window.innerHeight),sS.setPixelRatio(Math.min(window.devicePixelRatio,2)),iS.appendChild(sS.domElement);var cS=new lc,lS=new Cn;aS.add(lS);var uS=new Dr,dS=3e3,fS=new Float32Array(dS*3);for(let e=0;e<dS*3;e++)fS[e]=(Math.random()-.5)*100;uS.setAttribute(`position`,new fr(fS,3));var pS=new $i(uS,new Ji({size:.05,color:`#ffffff`,transparent:!0,opacity:.8,blending:2}));lS.add(pS);var mS=new vs,hS;mS.load(`/mountain.png`,e=>{let t=e.image,n=document.createElement(`canvas`),r=1800,i=r/t.width;n.width=r,n.height=Math.floor(t.height*i);let a=n.getContext(`2d`);a.drawImage(t,0,0,n.width,n.height);let o=a.getImageData(0,0,n.width,n.height).data,s=[],c=[],l=[],u=[],d=55*(n.height/n.width);for(let e=0;e<n.height;e++)for(let t=0;t<n.width;t++){let r=(e*n.width+t)*4,i=o[r],a=o[r+1],f=o[r+2];if(.299*i+.587*a+.114*f>2){let r=(t/n.width-.5)*55,o=-(e/n.height-.5)*d+5;s.push(r,o,0);let p=1.5;l.push(Math.min(1,i/255*p),Math.min(1,a/255*p),Math.min(1,f/255*p));let m=r*(1.5+Math.random()*2),h=o+15+Math.random()*20,g=25+Math.random()*15;c.push(m,h,g),u.push(Math.random()*Math.PI*2)}}let f=new Dr;f.setAttribute(`position`,new hr(s,3)),f.setAttribute(`aStartPos`,new hr(s,3)),f.setAttribute(`aTargetPos`,new hr(c,3)),f.setAttribute(`color`,new hr(l,3)),f.setAttribute(`aOffset`,new hr(u,1)),hS=new $i(f,new Lo({uniforms:{uTime:{value:0},uFlightProgress:{value:0},uOpacity:{value:0}},vertexShader:`
            uniform float uTime;
        ...
        `,transparent:!0,depthWrite:!1,blending:1})),lS.add(hS)});var gS={introProgress:0,brutalistOpacity:0,maskScale:9,maskRotY:0,maskRotX:0,maskOpacity:0,titleOpacity:0,birdFlight:0},_S=null,vS=new Pd,yS=new Rs(`#ff1a2b`,5);yS.position.set(5,5,-5),aS.add(yS);var bS=new Rs(`#ffffff`,3);bS.position.set(-5,-2,5),aS.add(bS);var xS=new Rs(`#ffffff`,1);xS.position.set(-5,0,10),aS.add(xS),vS.load(`/mask.glb`,e=>{_S=e.scene,_S.scale.set(gS.maskScale,gS.maskScale,gS.maskScale),_S.position.set(0,0,0),_S.traverse(e=>{e.isMesh&&e.material&&(e.material.color.setHex(16119260),e.material.roughness=.3,e.material.metalness=.5,e.material.transparent=!0,e.material.opacity=gS.maskOpacity,e.material.depthWrite=!1)}),lS.add(_S)}),window.addEventListener(`resize`,()=>{oS.aspect=window.innerWidth/window.innerHeight,oS.updateProjectionMatrix(),sS.setSize(window.innerWidth,window.innerHeight),sS.setPixelRatio(Math.min(window.devicePixelRatio,2))});var SS=0,CS=0;window.addEventListener(`mousemove`,e=>{SS=e.clientX/window.innerWidth*2-1,CS=-(e.clientY/window.innerHeight)*2+1});var wS,TS,ES,DS=new Y(0,0),OS=0,kS=!1;{wS=new Cn,wS.position.set(0,0,10),wS.visible=!1,lS.add(wS);let e=new Do(30,17,1,1),t=new Ht;ES=new Lo({uniforms:{uTime:{value:0},uChapter:{value:0},uOpacity:{value:0},uIntroProgress:{value:0},uMouse:{value:new Y(.5,.5)},uHover:{value:0},uScrollVelocity:{value:0},tImg1:{value:t},tImg2:{value:t},tImg3:{value:t},tImg4:{value:t}},vertexShader:$x,fragmentShader:eS,transparent:!0,side:2}),TS=new $r(e,ES),wS.add(TS),kS=!0}function AS(e){kS&&ES.uniforms.uChapter.value!==e&&(H_.killTweensOf(ES.uniforms.uOpacity),H_.to(ES.uniforms.uOpacity,{value:0,duration:.3,ease:`power2.in`,onComplete:()=>{ES.uniforms.uChapter.value=e,H_.to(ES.uniforms.uOpacity,{value:gS.brutalistOpacity,duration:.6,ease:`power2.out`})}}))}var jS=600,MS=new Float32Array(jS*3),NS=new Float32Array(jS),PS=new Float32Array(jS),FS=new Float32Array(jS);for(let e=0;e<jS;e++)MS[e*3]=(Math.random()-.5)*30,MS[e*3+1]=(Math.random()-.5)*18,MS[e*3+2]=11+Math.random()*4,NS[e]=.4+Math.random()*1.2,PS[e]=Math.random(),FS[e]=.025+Math.random()*.04;var IS=new Dr;IS.setAttribute(`position`,new fr(MS,3)),IS.setAttribute(`aSize`,new fr(NS,1)),IS.setAttribute(`aOffset`,new fr(PS,1)),IS.setAttribute(`aSpeed`,new fr(FS,1));var LS=new $i(IS,new Lo({uniforms:{uTime:{value:0},uOpacity:{value:0}},vertexShader:tS,fragmentShader:nS,transparent:!0,depthWrite:!1,blending:2}));LS.visible=!1,lS.add(LS);var RS=new zs(`#ffffff`,.2);aS.add(RS);var zS=new Rs(`#ffffff`,1.5);zS.position.set(10,20,-10),aS.add(zS);function BS(){requestAnimationFrame(BS);let e=cS.getElapsedTime();if(pS.rotation.y=e*.01,hS!==void 0&&hS&&(hS.material.uniforms.uTime.value=e,hS.material.uniforms.uFlightProgress.value=gS.birdFlight,hS.material.uniforms.uOpacity.value=1-gS.brutalistOpacity),_S){let t=gS.maskRotY+SS*.8+Math.sin(e*.5)*.1;_S.rotation.y+=(t-_S.rotation.y)*.1,_S.rotation.x=Math.cos(e*.3)*.05+CS*.2;let n=CS*.8,r=4.5+SS*.5;_S.position.x+=(r-_S.position.x)*.1,_S.position.y+=(n-_S.position.y)*.1,_S.scale.set(gS.maskScale*1.4,gS.maskScale,gS.maskScale),_S.traverse(e=>{e.isMesh&&e.material&&(e.material.opacity=gS.maskOpacity)})}if(ES!==void 0&&ES){ES.uniforms.uHover.value=Ct.lerp(ES.uniforms.uHover.value,OS,.1),ES.uniforms.uScrollVelocity.value=Ct.lerp(ES.uniforms.uScrollVelocity.value,window.lastScrollVelocity||0,.05);let e=new Y(DS.x,DS.y);ES.uniforms.uMouse.value.lerp(e,.08),wS&&(wS.visible=gS.brutalistOpacity>.005)}sS.render(aS,oS)}BS(),document.addEventListener(`DOMContentLoaded`,()=>{oS.position.set(0,2,20),oS.rotation.x=0,H_.timeline({scrollTrigger:{trigger:`#app`,start:`top top`,end:`+=200%`,scrub:1,onUpdate:e=>{}}}).to(gS,{birdFlight:1,duration:1.5,ease:`power1.inOut`},0).add(()=>{hS!==void 0&&hS&&(hS.visible=!1)},1.5).to(`.hero-title-container`,{opacity:1,scale:1,duration:.5,ease:`power2.out`},1.5).to(gS,{maskOpacity:.85,duration:.5,ease:`power2.out`},1.5).to(gS,{maskRotY:Math.PI/12,duration:1.5,ease:`power2.inOut`},2.5).to(`.hero-title-container`,{opacity:0,scale:1.1,duration:.3},5.5).to(gS,{maskOpacity:0,duration:.4},5.6).to(gS,{brutalistOpacity:1,duration:.5,ease:`power2.inOut`},5.7).to(`#br-shell`,{opacity:1,duration:.5,ease:`power2.inOut`},5.7).add(()=>{document.getElementById(`br-shell`)?.classList.add(`active`)},5.8).add(()=>{AS!==void 0&&AS(0)},5.7);function e(e){let t=[`br-ch-01`,`br-ch-02`,`br-ch-03`,`br-ch-04`];t.forEach((t,n)=>{if(n===e)return;let r=document.getElementById(t);r&&(H_.killTweensOf(r),r.querySelectorAll(`*`).forEach(e=>H_.killTweensOf(e)),H_.set(r,{opacity:0}),r.classList.remove(`active-ch`))});let n=document.getElementById(t[e]);if(!n)return;let r=n.querySelectorAll(`.br-word`),i=n.querySelector(`.br-body`),a=n.querySelector(`.br-divider`),o=n.querySelector(`.br-chapter-num`);H_.killTweensOf(n),n.querySelectorAll(`*`).forEach(e=>H_.killTweensOf(e)),n.classList.add(`active-ch`),H_.set(n,{opacity:1,clearProps:`visibility`}),H_.set(r,{y:`110%`}),i&&H_.set(i,{opacity:0,y:20}),H_.to(r,{y:`0%`,duration:.9,ease:`power4.out`,stagger:.08}),i&&H_.to(i,{opacity:1,y:0,duration:.8,delay:.35,ease:`expo.out`}),a&&H_.fromTo(a,{width:0},{width:`80px`,duration:.7,delay:.2,ease:`power3.out`}),o&&H_.fromTo(o,{opacity:0,x:-20},{opacity:1,x:0,duration:.5,ease:`power3.out`}),document.querySelectorAll(`.br-progress-tick`).forEach((t,n)=>{t.classList.toggle(`active`,n===e)});let s=document.getElementById(`br-chapter-counter`);s&&(s.textContent=`${String(e+1).padStart(2,`0`)} / 04`)}ox.create({trigger:`#brutalist-act`,start:`top top`,end:`+=400%`,pin:!0,onEnter:()=>e(0),onUpdate:t=>{let n=Math.min(3,Math.floor(t.progress*4)),r=document.getElementById(`br-chapter-counter`);(r?r.textContent:`01 / 04`)!==`${String(n+1).padStart(2,`0`)} / 04`&&e(n)}});let t;window.lastScrollVelocity=0,ox.create({trigger:`#app`,start:`top top`,end:`bottom bottom`,onUpdate:e=>{window.lastScrollVelocity=e.getVelocity()*.002,clearTimeout(t),t=setTimeout(()=>{window.lastScrollVelocity=0},100)}});let n=new oc,r=new Y;window.addEventListener(`mousemove`,e=>{if(r.x=e.clientX/window.innerWidth*2-1,r.y=-(e.clientY/window.innerHeight)*2+1,TS){n.setFromCamera(r,oS);let e=n.intersectObject(TS);e.length>0?(OS=1,DS.copy(e[0].uv)):OS=0}}),Tx(),Qx()});